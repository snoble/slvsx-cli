...
impl StlExporter {
        ...
        for (_id, entity) in entities {
            match entity {
                ...
                ResolvedEntity::Gear { center, teeth, module, .. } => {
                    // For now, treat gear as cylinder with pitch diameter
                    let pitch_diameter = (*teeth as f64 * module) * 2.0;
                    self.add_cylinder_to_stl(&mut stl, center, pitch_diameter)?;
                }
    ...
    fn add_cylinder_to_stl(&self, stl: &mut Vec<u8>, center: &[f64], diameter: f64) -> anyhow::Result<()> {
    ...
    fn add_quad_faces(&self, stl: &mut Vec<u8>, x1: f64, y1: f64, x2: f64, y2: f64, z1: f64, z2: f64) {
...
mod tests {
    ...
    fn test_export_circle_as_cylinder() {
        ...
        entities.insert("circle1".to_string(), ResolvedEntity::Circle {
    ...
    fn test_export_multiple_circles() {
        ...
        // Second circle
        entities.insert("circle2".to_string(), ResolvedEntity::Circle {
    ...
    fn test_add_cylinder_to_stl() {
        ...
        exporter.add_cylinder_to_stl(&mut stl, &center, diameter).unwrap();
