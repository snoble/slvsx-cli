...
* @returns {string}
*/
export function solve_constraints(json_str) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.solve_constraints(retptr, ptr0, len0);
...
* @returns {boolean}
*/
export function validate_document(json_str) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(json_str, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        wasm.validate_document(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {string}
*/
export function get_constraint_schema() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_constraint_schema(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export class WasmSolver {
    ...
    free() {
        ...
        wasm.__wbg_wasmsolver_free(ptr);
    }
    /**
    * Create a new WASM solver instance
    */
    constructor() {
        const ret = wasm.wasmsolver_new();
    ...
    */
    solve(json_str) {
        ...
        try {
            ...
            const ptr0 = passStringToWasm0(json_str, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            wasm.wasmsolver_solve(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
    ...
    */
    validate(json_str) {
        try {
            ...
            const ptr0 = passStringToWasm0(json_str, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            wasm.wasmsolver_validate(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('slvsx_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
